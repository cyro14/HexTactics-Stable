...
const LEADERS = [
    ...
    { id: 'admiral', name: 'Almirante', loreFaction: 'FORASTEIROS',emoji: '🏴‍☠️', hp: 65, atk: 13, mp: 5, range: 1, limit: 3, desc: 'Custo de movimento na Água é livre (1). Encontra e doma mais feras Abissais.', tags: ['ABYSSAL'], fav: ['WATER'], sprite: 'img/lideres/almirante.png' },
    ...
    { id: 'L_SIREN', name: 'Sereia',loreFaction: 'SILVESTRE', emoji: '🧜🏻‍♀️', hp: 70, maxHp: 70, mp: 3, maxMp: 3, atk: 10, range: 2, limit: 3, abilities: ['dive'], tags: ['ABYSSAL', 'MYSTIC'], fav: ['WATER'], desc: 'Usa a Canção da Sereia para puxar inimigos para perto e atordoá-los.', sprite: 'img/lideres/sereia.png' },
